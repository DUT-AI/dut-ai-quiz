...
def upgrade() -> None:
    ...
    op.add_column(
        'questions',
        sa.Column('is_answer_ai_generated', sa.Boolean(), nullable=False,
                  server_default='false'),
    )
    op.add_column(
        'questions',
        sa.Column('is_solution_ai_generated', sa.Boolean(), nullable=False,
                  server_default='false'),
    )
    op.add_column(
        'questions',
        sa.Column('is_difficulty_ai_suggested', sa.Boolean(), nullable=False,
                  server_default='false'),
    )
    op.add_column(
        'questions',
        sa.Column('duplicate_status', sa.String(30), nullable=False,
                  server_default='UNIQUE'),
    )
    op.add_column(
        'questions',
        sa.Column('duplicate_of_question_id', postgresql.UUID(as_uuid=True),
                  nullable=True),
    )
    op.add_column(
        'questions',
