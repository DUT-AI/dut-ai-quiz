...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('IN_PROGRESS', 'COMPLETED', name='practicesessionstatus'), nullable=False),
    sa.Column('snapshot', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('tags_filter', postgresql.ARRAY(sa.String()), nullable=False),
    sa.Column('difficulty_filter', sa.Enum('EASY', 'MEDIUM', 'HARD', name='difficulty'), nullable=True),
    ...
    op.create_index(op.f('ix_focus_events_attempt_id'), 'focus_events', ['attempt_id'], unique=False)
