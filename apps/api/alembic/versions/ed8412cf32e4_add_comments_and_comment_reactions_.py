...
down_revision: Union[str, None] = 'd7f1a3ed798a'
...
def upgrade() -> None:
    ...
    sa.Column('target_type', sa.Enum('system_feedback', 'lesson_qna', name='targettype', native_enum=False, length=50), nullable=False),
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('reaction_type', sa.Enum('like', 'dislike', name='reactiontype', native_enum=False, length=20), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
