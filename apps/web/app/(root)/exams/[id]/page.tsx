...
export default function ExamEntrancePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      <Link 
        href="/exams"
        className="inline-flex items-center gap-2 text-gray-navy dark:text-light-blue/60 hover:text-primary transition-colors font-bold text-sm"
      >
      ...
      >
        ...
        <div className="relative space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-center gap-4 p-6 rounded-3xl bg-gray-50 dark:bg-white/5 border border-transparent hover:border-primary/20 transition-colors">
            ...
            <div className="flex items-center gap-4 p-6 rounded-3xl bg-gray-50 dark:bg-white/5 border border-transparent hover:border-primary/20 transition-colors md:col-span-2">
              <div className="size-12 rounded-2xl bg-white dark:bg-navy-blue flex items-center justify-center shadow-sm">
          ...
          <div className="pt-6 border-t border-gray-100 dark:border-white/5 flex flex-col items-center gap-6">
            <button
              onClick={handleStart}
              disabled={isStarting}
              className="group relative w-full md:w-auto min-w-[300px] h-20 bg-primary text-white rounded-[2rem] font-black text-xl shadow-2xl shadow-primary/30 hover:scale-[1.02] active:scale-95 transition-all overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
            >
